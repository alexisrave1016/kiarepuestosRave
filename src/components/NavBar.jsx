    ...
    <div className='container-navBar'>
        <div className="navBar">
            ...
            <div className="login">
                ...
                <Link to='/login' className='link'><span className='texto-navBar login-registro'>Iniciar secion</span></Link>
                <Link to='/registro' className='link'><span className='texto-navBar login-registro'>Registrate</span></Link> 
            </div>
        </div>
    </div>
  )
